                                                    ...
                                                    <div class="col">
                                                        ...
                                                        <div class="card mb-3">
                                                            <div class="card-header" style="background-color: #EADBC8; font-size: 20px; font-weight: bold;">
                                                                ...
                                                                <select class="form-control" id="bk_cat" name="bk_cat" required onchange="redirectToPage()" style="width: 200px;">
                                                                    <option value="cart.php">My Basket</option>
                                                                    <option value="pending.php" selected>Pending Request(s)</option>
