                                                        ...
                                                        <div class="card mb-3">
                                                            <div class="card-header" style="background-color: #EADBC8; font-size: 20px; font-weight: bold;">
                                                                ...
                                                                <select class="form-control" id="bk_cat" name="bk_cat" required onchange="redirectToPage()" style="width: 20%;">
                                                                    ...
                                                                    <option value="borrowed.php" selected>Borrowed Books</option>
                                                                </select>
                                                            </div>
                                                            <div class="card-body">
                                                                ...
                                                                <table id="dataTable" class="table table-bordered table-striped" style="font-size:15px">
                                                                    <thead>
                                                                        <tr>
                                                                            ...
                                                                            <th class="text-center" colspan="2">Due Date</th> <!-- Add colspan="2" to span two columns -->
                                                                        </tr>
                                                                    </thead>
                                                                    <tbody>
                                                                        <?php
                                                                            $query = mysqli_query($conn, "SELECT cart.*, book.bk_title, transaction.due_date, transaction.status 
                                                                                                                FROM cart 
                                                                                                                ...
                                                                                                                WHERE cart.user_id = '" . $_SESSION['user_id'] . "' 
                                                                                                                    AND (transaction.status IS NULL OR transaction.status = 'borrowed')
                                                                        ...
                                                                        while($row = mysqli_fetch_assoc($query)): ?>
                                                                            <tr>
                                                                                ...
                                                                                <td style="text-align: center;"><?php echo date('F j, Y', strtotime($row['due_date'])); ?></td>
