                                                                    ...
                                                                    <tbody>
                                                                        <?php
                                                                            $query = mysqli_query($conn, "SELECT cart.*, book.bk_title, transaction.status 
                                                                                                            ...
                                                                                                            LEFT JOIN transaction ON cart.user_id = transaction.user_ID AND cart.ISBN = transaction.ISBN
                                                                                                            WHERE cart.user_id = '" . $_SESSION['user_id'] . "' 
                                                                                                            AND (transaction.status IS NULL OR (transaction.status != 'cancelled'))
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td class="text-center">
                                                                                    ...
                                                                                    <?php
                                                                                        ...
                                                                                        // If status is 'approved', display a disabled button or any other appropriate action
                                                                                        ?>
